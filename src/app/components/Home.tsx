...
const Home = () => {
    return (
        <React.Fragment>
            <h2>Chronicles </h2>
            <p>
                Chronicles allow you to view inside World of Warcraft a timeline
                and browse through the events of the past.
                <br />
                Each event include related factions and characters with a resume
                of what happened.
            </p>
            <p>
                ...
                automatically include your character birthdate to the timeline.
            </p>
            <p>
                If you want to backup your customed events you can view them in
                the Chronicles.lua file located here : <br />
                <Box
                    component="span"
                    sx={{
                        fontWeight: "bold",
            ...
            <p>
                This project is still under development, mostly due to the huge
            ...
            <ul>
                ...
                <li>
                    zoom in and out into the timeline, available steps are 1000,
                    500 or 250 years
                </li>
                <li>
                    select a time period to display the corresponding list of
                    events
                </li>
                <li>
                ...
                <li>
                    view factions and characters related to the selected event
                </li>
                <li>
                    filter events by type or source if using external libraries
                </li>
            ...
            <p>
                The current list of events include in the addon is limited, as
                the core is now ready I will be able to work on the data to
                display. This means gathering events, prepare the text to
