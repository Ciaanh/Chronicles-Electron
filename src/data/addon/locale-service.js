...
service.FormatIndex = function(index, dbname, language, typeName) {
...
// Locales.xml
service.localesIndex = function(dbnames, events, factions, characters) {
...
service.GenerateLocales = function(
    dbnames,
    events,
    factions,
    characters,
    ...
    var localesIndex = service.localesIndex(
        dbnames,
        events,
        factions,
        characters
